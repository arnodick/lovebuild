...
:: PROJECTSDIR is a path to the directory where your LOVE projects are. the folder that has you game's Lua code in it should be the same as GAMENAME, and needs to be in this folder.
